...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Spell::insert([
            ...
            'duration' => 'concentration, jusqu\'à 1 minute',
            'description' => '<p>Ce sort assaille et pervertit l\'esprit des créatures, générant des hallucinations et provoquant des réactions incontrôlées. Toutes les créatures situées dans une sphère de 3 mètres de rayon autour d\'un point de votre choix situé à portée doivent faire un jet de sauvegarde de Sagesse quand vous lancez le sort. Si elles échouent, le sort les affecte.</p><p> Une cible affectée ne peut pas accomplir de réaction et doit lancer 1d10 au début de chacun de ses tours pour déterminer comment elle se comporte pendant le tour.</p><p><table><thead><th>d10</th><th>Comportment</th></thead><tbody><tr><td>1</td><td>La créature utilise la totalité de son mouvment pour se déplacer dans une direction aléatoire. Pour déterminer cette dernière, lancez un d8 en assignant une direction à chaque face. La créature n\'effectue aucune action pour ce tour.</td></tr><tr><td>2-6</td><td>La créature ne bouge pas et n\'entreprend pas la moindre action pour ce tour.</td></tr><tr><td>7-8</td><td>La créature utilise sont action pour porter une attaque au corps à corps contre une créature aléatoire à portée d\'allonge. S\'il n\'y a pas de créature à portée, elle ne fait rien du tour.</td></tr><tr><td>9-10</td><td>La créature peut agir et se déplacer normalement.</td></tr></tbody></table></p><p> Une créature affectée peut faire un jet de sauvegarde de Sagesse à la fin de chacun de ses tours. En cas de succès, l\'effet se termine pour elle.</p>',
        ...
        Spell::insert([
            ...
            'duration' => 'concentration, jusqu\'à 10 minutes',
            'description' => '<p>Vous voyez et entendez une créature donnée de votre choix, à condition qu\'elle se trouve sur le même plan d\'existence que vous. La cible doit faire un jet de sauvegarde de Sagesse, modifié par le degré de connaissance que vous avez d\'elle et le type de lien physique que vous avez établi avec elle. Si la cible sait que vous lancez ce sort, elle peut rater volontairement son jet de sauvegarde si elle veut que vous l\'observiez.</p><p><table><thead><th>Connaissance</th><th>Modificateur du jet de sauvegarde</th></thead><tbody><tr><td>Deuxième main (vous avez entendu parler de la cible)</td><td>+5</td></tr><tr><td>Première main (vous avez rencontré la cible)</td><td>+0</td></tr><tr><td>Familière (vous connaissez la cible)</td><td>-5</td></tr></tbody></table></p><p><table><thead><th>Lien</th><th>Modificateur du jet de sauvegarde</th></thead><tbody><tr><td>Représentation ou portrait</td><td>-2</td></tr><tr><td>Possession ou habit</td><td>-4</td></tr><tr><td>Partie du corps, cheveux, ongles, etc</td><td>-10</td></tr></tbody></table></p><p> Si la cible réussit son jet de sauvegarde, elle n\'est pas affectée et vous ne pouvez plus utiliser ce sort sur elle pendant 24 heures.</p><p> Si elle rate son jet, le sort crée un organe sensoriel invisible dans un rayon de 3 mètres autour d\'elle. Vous voyez et entendez à travers cet organe comme si vous vous trouviez à sa place. L\'organe sensoriel se déplace avec la cible et reste dans un rayon de 3 mètres autour d\'elle pendant toute la durée du sort. Une créature capable de voir les objets invisibles perçoit l\'organe sensoriel comme un orbe lumineux de la taille de votre poing.</p><p> Au lieu de prendre une créature pour cible, vous pouvez choisir un lieu que vous avez déjà vu. L\'organe sensoriel apparaît alors à cet endroit et n\'en bouge pas.</p>'
        ]);
        Spell::insert([
            'id' => Str::uuid(),
            'name' => 'Sens animal',
