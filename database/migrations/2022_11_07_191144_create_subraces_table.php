...
return new class extends Migration {
    ...
    public function up()
    {
        ...
        Subrace::insert([
            'id' => Str::uuid(),
            'name' => 'Sylvestre',
            'description' => 'En tant qu\'elfe des bois (ou elfe sylvestre), vous avez des sens aiguisés et une excellente intuition. De plus, vos pieds agiles vous emportent rapidement et sans bruit au travers de votre forêt natale. Vous faites partie d\'un peuple isolationniste qui n\'accorde aucune confiance aux membres des races autres qu\'elfiques.',
            'is_after' => true,
            'race_id' => Race::where('name', 'Elfe')->first()->getKey()
        ]);
        Subrace::insert([
            'id' => Str::uuid(),
            'name' => 'Noir (Drow)',
            'description' => 'Comme tout drow, vous êtes imprégné par la magie d\'Outreterre, ce royaume souterrain fais de merveilles et d\'horreurs presque inconnues à la surface. Les ombres restent votre domaine et vos aptitudes innées vous permettent d\'invoquer la lumière comme les ténèbres.',
            'is_after' => true,
            'race_id' => Race::where('name', 'Elfe')->first()->getKey()
        ]);
        Subrace::insert([
        ...
        Subrace::insert([
            'id' => Str::uuid(),
            'name' => 'Pied-léger',
            'description' => 'En tant qu\'halfelin pied-léger, vous cacher est presque une seconde nature et vous n\'hésitez pas à vous dissimuler derrière d\'autres créatures pour échapper aux regards. Vous êtes d\'un naturel plutôt affable et sympathique. Vous êtes la variante racial la plus répandus et donc, la plus courante. Vous êtes plus portés sur le voyage que vos congénères et vous cohabitez généralement avec d\'autres races ou bien choisissez une vie nomade.',
            'is_after' => true,
            'race_id' => Race::where('name', 'Halfelin')->first()->getKey()
        ]);
        Subrace::insert([
        ...
        Subrace::insert([
            'id' => Str::uuid(),
            'name' => 'des Collines',
            'description' => 'En tant que nain des collines, vous avez des sens aiguisés, une excellente intuition et une résistance remarquable. Vous habitez de lointains royaumes au sud et gardez généralement vos distances avec les humains.',
            'is_after' => true,
            'race_id' => Race::where('name', 'Nain')->first()->getKey()
        ]);
        Subrace::insert([
            'id' => Str::uuid(),
            'name' => 'des Montagnes',
            'description' => 'En tant que nain des montagnes, vous êtes fort et robuste, habitué à mener une vie difficile dans des zones accidentées. Vous aimez les pierres précieuse, et, travailler au coeur de votre montagne à la recherche de richesse est loin d\'être une corvé sinon un objectif.',
            'is_after' => true,
            'race_id' => Race::where('name', 'Nain')->first()->getKey()
        ]);
        Subrace::insert([
        ...
        Subrace::insert([
            'id' => Str::uuid(),
            'name' => 'des roches',
            'description' => 'En tant que gnomes des roches, vous êtes naturellement plus inventifs et résistants que les autres gnomes. Le bricolage est votre grande spécialité car de votre esprit résulte toutes sortes d\'objets qui peux être fabriqué avec de simple matériaux.',
            'is_after' => true,
            'race_id' => Race::where('name', 'Gnome')->first()->getKey()
        ]);
        Subrace::insert([
