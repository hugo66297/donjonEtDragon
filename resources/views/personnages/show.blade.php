<x-app-layout>
    ...
    <div class="flex" aria-label="Sidebar">
        <div class="box-border py-4 px-3 mx-0.5 bg-gray-50 rounded dark:bg-gray-800">
            <ul class="space-y-2" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                <li>
                    <button data-tooltip-target="tooltip-default" data-tooltip-placement="right" class="flex p-2 rounded-t-lg text-red-600" id="infos-tab" data-tabs-target="#infos" role="tab" aria-controls="infos" aria-selected="false">
                ...
                <li>
                    <button data-tooltip-target="tooltip-primaires" data-tooltip-placement="right" class="flex p-2 rounded-t-lg text-red-600" id="primaires-tab" data-tabs-target="#primaires" type="button" role="tab" aria-controls="primaires" aria-selected="false">
                ...
                <li>
                    <button data-tooltip-target="tooltip-armes" data-tooltip-placement="right" class="flex p-2 rounded-t-lg text-red-600" id="armes-tab" data-tabs-target="#armes" type="button" role="tab" aria-controls="armes" aria-selected="false">
                ...
                <li>
                    <button data-tooltip-target="tooltip-levels" data-tooltip-placement="right" class="flex p-2 rounded-t-lg text-red-600" id="levels-tab" data-tabs-target="#levels" type="button" role="tab" aria-controls="levels" aria-selected="false">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="flex-shrink-0 w-6 h-6 transition duration-75 group-hover:text-red-600" fill="currentColor">
        ...
        <div id="myTabContent" class="mx-0.5">
            <div class="hidden p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="infos" role="tabpanel" aria-labelledby="infos-tab">
                <p class="text-sm text-gray-500 dark:text-gray-400">This is some placeholder content the <strong class="font-medium text-gray-800 dark:text-white">Profile tab's associated content</strong>. Clicking another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to control the content visibility and styling.</p>
            </div>
            <div class="hidden p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="primaires" role="tabpanel" aria-labelledby="primaires-tab">
                <p class="text-sm text-gray-500 dark:text-gray-400">This is some placeholder content the <strong class="font-medium text-gray-800 dark:text-white">Dashboard tab's associated content</strong>. Clicking another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to control the content visibility and styling.</p>
            </div>
            <div class="hidden p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="secondaires" role="tabpanel" aria-labelledby="secondaires-tab">
                <p class="text-sm text-gray-500 dark:text-gray-400">This is some placeholder content the <strong class="font-medium text-gray-800 dark:text-white">Settings tab's associated content</strong>. Clicking another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to control the content visibility and styling.</p>
            </div>
            <div class="hidden p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="armes" role="tabpanel" aria-labelledby="armes-tab">
                <p class="text-sm text-gray-500 dark:text-gray-400">This is some placeholder content the <strong class="font-medium text-gray-800 dark:text-white">Contacts tab's associated content</strong>. Clicking another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to control the content visibility and styling.</p>
            </div>
            <div class="hidden p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="maitrises" role="tabpanel" aria-labelledby="maitrises-tab">
                <p class="text-sm text-gray-500 dark:text-gray-400">This is some placeholder content the <strong class="font-medium text-gray-800 dark:text-white">Contacts tab's associated content</strong>. Clicking another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to control the content visibility and styling.</p>
            </div>
            <div class="hidden p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="levels" role="tabpanel" aria-labelledby="levels-tab">
                <p class="text-sm text-gray-500 dark:text-gray-400">This is some placeholder content the <strong class="font-medium text-gray-800 dark:text-white">Contacts tab's associated content</strong>. Clicking another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to control the content visibility and styling.</p>
            </div>
        </div>
    </div>
