<x-app-layout>
    <ol class="flex items-center sm:w-4/5 sm:ml-[10%] p-4">
        <li id="step-1" class="active flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-700 after:border-4 after:inline-block">
            <span class="flex items-center justify-center w-10 h-10 bg-red-800 rounded-full lg:h-12 lg:w-12 shrink-0">
                <svg id="step-0-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="w-5 h-5 text-gray-100 lg:w-6 lg:h-6" fill="currentColor">
        ...
        <li id="step-2" class="flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-700 after:border-4 after:inline-block">
            <span class="flex items-center justify-center w-10 h-10 bg-gray-700 rounded-full lg:h-12 lg:w-12 shrink-0">
                <svg id="step-1-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-5 h-5 text-gray-100 lg:w-6 lg:h-6" fill="currentColor">
        ...
        <li id="step-3" class="flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-700 after:border-4 after:inline-block">
            <span class="flex items-center justify-center w-10 h-10 bg-gray-700 rounded-full lg:h-12 lg:w-12 shrink-0">
                <svg id="step-2-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 text-gray-100 lg:w-6 lg:h-6" fill="currentColor">
        ...
        <li id="step-4" class="flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-700 after:border-4 after:inline-block">
            <span class="flex items-center justify-center w-10 h-10 bg-gray-700 rounded-full lg:h-12 lg:w-12 shrink-0">
                <svg id="step-3-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="w-5 h-5 text-gray-100 lg:w-6 lg:h-6" fill="currentColor">
    ...
    <form action="{{route('heroes.store')}}" method="post" id="form-perso">
        ...
        <div class="flex items-center justify-center space-x-8 p-4">
            ...
            <div id="next" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 disabled:opacity-25 transition ease-in-out duration-150 cursor-pointer">
