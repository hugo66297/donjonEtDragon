<x-app-layout>
    ...
    <div class="flex" aria-label="Sidebar">
        <div class="box-border py-3 px-2 rounded-r bg-gray-800">
            <ul class="space-y-2" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                ...
                <li>
                    <button data-tooltip-target="tooltip-primaires" data-tooltip-placement="right" class="flex p-2 rounded-t-lg" id="stats-tab" data-tabs-target="#stats" type="button" role="tab" aria-controls="primaires" aria-selected="false">
                ...
                <li>
                    <button data-tooltip-target="tooltip-armes" data-tooltip-placement="right" class="flex p-2 rounded-t-lg" id="attaques-tab" data-tabs-target="#attaques" type="button" role="tab" aria-controls="armes" aria-selected="false">
                ...
                <li>
                    <button data-tooltip-target="tooltip-maitrises" data-tooltip-placement="right" class="flex p-2 rounded-t-lg" id="maitrises-tab" data-tabs-target="#maitrises" type="button" role="tab" aria-controls="maitrises" aria-selected="false">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="flex-shrink-0 w-6 h-6 transition duration-75" fill="currentColor">
                ...
                <li>
                    <button data-tooltip-target="tooltip-levels" data-tooltip-placement="right" class="flex p-2 rounded-t-lg" id="origine-tab" data-tabs-target="#origine" type="button" role="tab" aria-controls="levels" aria-selected="false">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="flex-shrink-0 w-6 h-6 transition duration-75" fill="currentColor">
