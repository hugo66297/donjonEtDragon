    ...
    <div class="grid grid-cols-2 gap-8">
        ...
        <div class="relative col-span-2">
            ...
            <textarea id="past" name="hero[character_past]" rows="4"
                      class="block p-2 w-full text-sm text-gray-900 bg-gray-50 rounded-md border border-gray-600 placeholder-gray-400 focus:ring-red-800 focus:border-red-800"
    ...
    <div class="grid grid-cols-3 gap-8">
        <div class="relative">
            <input type="number" id="armure" name="hero[armor_class]"
                   class="block p-2 w-full text-sm bg-transparent rounded-md border-1 border-gray-600 appearance-none focus:outline-none focus:ring-0 focus:border-red-800 peer"
