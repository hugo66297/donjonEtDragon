<x-app-layout>
    <div class="h-full md:h-[100vh] bg-cover bg-center flex flex-col justify-center items-center gap-8 border-b-2 border-red-700" style="background-image: url('{{ asset('storage/img/home-hero-image.jpg') }}');">
        <div class="m-2 md:m-0 max-w-md bg-[#e7e7db] rounded-xl shadow-md overflow-hidden md:max-w-2xl">
            <div class="md:flex">
                ...
                <div class="p-4 text-justify">
                    <p class="mt-1 text-slate-500">
                        ...
                        différents maitres de jeu, ils peuvent être confrontés à des énigmes, des défis et bien plus encore. Nous vous présentons ici
                    ...
                    <div class="mt-5 flex items-center justify-end text-lg leading-tight font-medium text-black text-right">
                        <a href="{{ route('aboutD&D') }}" class="hover:underline">
                            Plus de détails
                        </a>
                        <span class="ml-1">
            ...
            <div class="md:flex">
                ...
                <div class="p-4 text-justify">
                    <p class="mt-1 text-slate-500">
                        ...
                        total d’environ 40 h de jeu. Dans ce scénario, vous trouverez tous les aspects de Donjon et Dragon à savoir : de
                        ...
                        et défiez-vous attendent… Peux-être même un dragon, qui sait…
                    </p>
                    <div class="mt-5 flex items-center justify-end text-lg leading-tight font-medium text-black text-right">
